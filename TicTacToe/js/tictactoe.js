...
function placeXOrO(squareNumber) {
    ...
    //This function parses the selecteDquares array to search for win conditions. drawLine() function is called to draw a line on the screen if the condition is met.
    ...
    function checkWinConditions() {
        ...
        // X 0, 3, 6 condition
        else if (arrayIncludes('0X', '3X', '6X')) {drawWinLine(50,100,100,558)}
        // X 1, 4, 7 condition
        ...
        // O 0, 3, 6 condition
        else if (arrayIncludes('0O', '3O', '6O')) {drawWinLine(50,100,100,558)}
        // O 1, 4, 7 condition
    ...
    //this function makes our body element temporarilly unclickable
        ...
        let x1 = coordX1,
            ...
            function animateLineDrawing() {
                ...
                if (x1 <= x2 && y1 <= y2) {
                    ...
                    if (y < y2) { y += 10; }
                    //this condition is similar to the one above, it is necessary for the 6, 4, 2 win conditions
                    if (x >= x2 && y >= y2) {cancelAnimationFrame(animationLoop); }
                }
                //this condition is similar to the one above, and is also necessary for the 6, 4, 2 wind condition
                if (x1 <= x2 && y1 >= y2) {
                    if (x < x2) { x += 10; }
                    if (y > y2) { y -= 10; }
                    if (x >= x2 && y <= y2) {cancelAnimationFrame(animationLoop); }
